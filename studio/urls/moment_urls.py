...
from studio.views.moment_views import MomentsView, CreateMomentView, UpdateMomentView, DeleteMomentView, MomentView
...
urlpatterns = [
    ...
    path('select/<int:pk>/', MomentView.as_view(), name='moment_view'),
]
